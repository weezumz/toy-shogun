...
export default function Sidebar() {
  ...
  return (
    <div style={{
      ...
      <div style={{ padding: '24px 20px', borderBottom: '1px solid #ffffff20' }}>
        <h5 className="fw-bold mb-0">⚔️ Toy Shogun</h5>
        <small style={{ color: '#ffffff80' }}>Hobby Shop System</small>
      </div>
